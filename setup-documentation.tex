...
\begin{enumerate}
    \item Vào \textbf{Dashboards > New Dashboard}
    \item Chọn \textbf{Add Visualization}
    \item Chọn Data Source là \textbf{Loki}
    \item Nhập query: \lstinline{{job="application"}}
    \item Chọn visualization type: \textbf{Logs}
    \item Save dashboard
\end{enumerate}
